...
% Seating problem around a table with 6 chairs (version b)

%  1 won't sit next to 2
%  4 won't sit next to 5
%  3 must  sit next to number 1
...
table :-
  ...
  % 3 must sit next to 1 
  [~p31, p12, p16], [~p32, p13, p11], [~p33, p14, p12],
  [~p34, p15, p13], [~p35, p16, p14], [~p36, p11, p15],

  % 3 must sit next to 4 
  [~p31, p42, p46], [~p32, p43, p41], [~p33, p44, p42],
  [~p34, p45, p43], [~p35, p46, p44], [~p36, p41, p45],

  % 3 must sit next to 6. 
  [~p31, p62, p66], [~p32, p63, p61], [~p33, p64, p62],
  [~p34, p65, p63], [~p35, p66, p64], [~p36, p61, p65]
